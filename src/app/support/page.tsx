          ...
          <Card>
            <VStack gap={3}>
              ...
              <ChatLayout>
                <ChatMessageList>
                  <ChatMessage>
                    <ChatMessageBubble variant="incoming">Hi! How can I help you today?</ChatMessageBubble>
                  </ChatMessage>
                  <ChatMessage>
                    <ChatMessageBubble variant="outgoing">I'd like to track my order #1043.</ChatMessageBubble>
                  </ChatMessage>
                  <ChatMessage>
                    <ChatMessageBubble variant="incoming">Let me look that up for you. Your order #1043 — the Minimalist Watch and Linen Throw — shipped this morning and is currently in transit with UPS. It's on track to arrive by end of day tomorrow.</ChatMessageBubble>
                  </ChatMessage>
                </ChatMessageList>
                <ChatComposer placeholder="Type your message..." />
              </ChatLayout>
            </VStack>
          </Card>
        </Tab>
